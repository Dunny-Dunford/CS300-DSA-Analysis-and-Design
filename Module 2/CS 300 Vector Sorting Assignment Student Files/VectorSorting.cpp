...
int main(int argc, char* argv[]) {
    ...
    while (choice != 9) {
        ...
        case 3:
            ...
            selectionSort(bids);
            ticks = clock() - ticks;
            cout << "Selection Sort time: " << static_cast<double>(ticks) / CLOCKS_PER_SEC << " seconds" << endl;
            break;
        ...
        case 4:
            ...
            ticks = clock() - ticks;
            cout << "Quick Sort time: " << static_cast<double>(ticks) / CLOCKS_PER_SEC << " seconds" << endl;
            break;
        }
    }
